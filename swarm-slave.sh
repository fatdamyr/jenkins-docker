...
echo ' - Jenkins Slave Home:	 ' $JENKINS_SLAVE_HOME

ARGUMENT="-jar /var/jenkins-swarm/swarm-slave.jar -fsroot $JENKINS_SLAVE_HOME -disableSslVerification -executors $JENKINS_SLAVE_EXECUTORS"
